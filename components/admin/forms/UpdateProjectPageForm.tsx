...
import { getProject, updateProject } from "@/actions/projects.action";
import { Projects } from "@prisma/client";

type ProjectUpdatePageFormProps = {
	projectId: string;
};

const ProjectUpdatePageForm = ({ projectId }: ProjectUpdatePageFormProps) => {
	...
	const fetchProjectData = async () => {
		try {
			const project: Projects | any = await getProject(projectId);
			if (project) {
				setTitle(project.title);
				setLink(project.link);
				setDescription(project.description);
				setImageUrl(project.imgUrl);
...
export default ProjectUpdatePageForm;
